	...
	public void tick()
	{
		...
		for (int i = 0; i < textboxes.size(); i++)
		{
			...
			if (b.active)
			{
				...
				main.fill(0, 0, 0, 180);
				int border = 1;
				main.rect(b.posX + border, b.posY + border, b.sizeX - 2*border, b.sizeY - 2*border);
				...
				for (int i = 0; i < menus.get(menu).buttons.size(); i++)
				{
					...
					if (b.active)
					{
						...
						else
						{
							...
							//main.fill(main.grid.civs[0].r, main.grid.civs[0].g, main.grid.civs[0].b, 100);
							//int border = 1;
							//main.rect(b.posX + border, b.posY + border, b.sizeX - 2*border, b.sizeY - 2*border);
